...
shinyServer(function(input, output) {
    ...
    output$text <- renderText({
        ...
        "To maximize the investment return on the healthcare industry, social impact related to the investment is investigated. How does the social impact affect the healthcare industry? What are social impact indexes? What’s the relationship between investment return and social impact? This shiny dashboard delivers a straightforward answer for these questions. Investors can dig into this dashboard for further analysis before providing the maximized investment portfolio."
    ...
    output$scatter <- renderPlotly({
      ...
      fig <- plot_ly(data,y= ~data$"Total.Return",x= ~data$"Impact_Alpha",type = "scatter",
    ...
    output$alpha <- DT::renderDataTable(DT::datatable({
      input$go
      df <- update_data()
      df <- df[,c("Company.Name","Impact_Alpha")]
