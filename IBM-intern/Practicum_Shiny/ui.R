                                       ...
                                       sidebarLayout(
                                         ...
                                         sidebarPanel(
                                           ...
                                           selectInput("company2", "Choose Five Companies to Visualize Metrics:",
                                                       ...
                                                       multiple =TRUE,
                                                       selected = "Zealand Pharma A/S ADR",
                                                       selectize = TRUE)
                                           ),
                              ...
                              tabPanel("Investment Return VS. Impact Alpha",
                                       sidebarLayout(
                                         sidebarPanel(
                                           ...
                                           helpText("Note: Investment return score represent recommendation rating for investment.1:Strong Buy 2:Buy 3: Hold 4:Under-Perform 5:Sell")
                                          ),
                   ...
                   tabPanel("Impact Alpha",
                            sidebarLayout(
                              sidebarPanel(
                                ...
                                actionButton('go',"Update Company and Weights"),
